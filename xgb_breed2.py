...
if __name__ == '__main__':
    ...
    train_file = "data/train_feat_v2.csv"
    test_file = "data/test_feat_v2.csv"
    ensem_pred_file = "data/ensem_xgb_pred_v2.csv"
    test_pred_file = "data/xgb_blend/test_xgb_b2_88.csv"
    ...
    mapper = DataFrameMapper([(['Breed', 'Breed2'],
                               [FunctionTransformer(array_to_dict, validate=False), DictVectorizer()]),
                              (['Color', 'Color2'],
                               [FunctionTransformer(array_to_dict, validate=False), DictVectorizer()]),
